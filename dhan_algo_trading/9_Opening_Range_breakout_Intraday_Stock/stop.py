#!/usr/bin/env python3
"""Create a local stop signal for the Opening Range Breakout bot.
...
4. Closes positions only if ``safety.close_positions_on_stop``
...
def main() -> int:
    ...
    if running:
        ...
        return 0
    print("No running ORB bot was detected.")
