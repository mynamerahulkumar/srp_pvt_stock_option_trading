#!/usr/bin/env python3
"""Create a local stop signal for the EMA + VWAP Scalper.
...
4. Closes positions only if ``safety.close_positions_on_shutdown``
...
def main() -> int:
    ...
    if running:
        ...
        return 0
    print("No running EMA + VWAP Scalper was detected.")
