#!/usr/bin/env python3
"""Create a local stop signal for the VWAP Momentum bot.
...
4. Closes positions only if ``shutdown.close_positions_on_manual_stop``
...
def main() -> int:
    ...
    if running:
        ...
        return 0
    print("No running VWAP Momentum bot was detected.")
